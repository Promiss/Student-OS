...
# 一站式学生综合服务系统 (SUDT) - 数据库上云迁移脚本

REMOTE_HOST="49.232.58.170"
REMOTE_USER="root"
REMOTE_PORT="3306"
REMOTE_PASS="70c3667ee5edef98"
DB_NAME="sudt_db"
BACKUP_FILE="sudt_db_backup.sql"
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "[失败] 数据库迁移异常，请检查网络连接、账密或 MySQL 客户端是否已安装配置。"
fi
